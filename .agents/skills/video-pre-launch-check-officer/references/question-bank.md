...
[全量维度索引]
    ...
    Phase 1 · 视频基本盘（必问 gate）
        ...
        1.4 信息密度 /
        1.5 品牌 Tone of Voice / 1.6 观众熟悉度
...
[Phase 1 · 视频基本盘]
    ...
    [1.1 · 视频目的]
        ...
        [主问题]
            - 这个视频要解决什么问题？看完之后希望观众做什么，或者改变什么判断？
            - 这是科普 / 营销 / 教学 / 产品演示 / 品牌 / 纪录 哪一类？混合的不算，挑主导。
            - 看完之后用户应该有什么具体行动？点链接？分享转发？下载？注册？还是继续看下一条？
        ...
        [接受标准]
            - 能说清楚"是什么类型 + 给谁看 + 看完希望发生什么行为或判断变化"
            - 例如：这是产品演示视频，给 SaaS 团队的产品经理看，看完去官网注册免费试用
            - 例如：这是品牌纪录片，给设计圈从业者看，看完愿意把视频转发到同行群
    ...
    [过渡话术示例 · 聊完基本盘 → 开始聊素材]
        ...
        ✓ "好，你这视频的基本盘我懂了——[复述目的/受众/平台/时长/节奏取向中关键的几条]。现在我们看看你手头有什么素材。"
...
[Phase 3 · 表达手段激发]
    ...
    [3.4 · 节奏基准]
        [覆盖意图]
            节奏档位的具体参数（镜头数 / 字数）在 Phase 1.4 之后再精确化一遍，
            避免脚本字数和素材数对不上时长。
