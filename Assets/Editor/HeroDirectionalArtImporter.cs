...
{
    public sealed class HeroDirectionalArtImporter : AssetPostprocessor
    {
        public const string Folder = "Assets/Resources/Characters/HeroEightDirections";
        ...
        [MenuItem("37 MiniGame/Art/Reimport Hero Eight Directions")]
        public static void ImportAll()
        {
            foreach (string path in Directory.GetFiles(Folder, "*.png"))
            {
                ...
                int count = basename.Contains("_run_") ? 8 : 1;
            ...
            Debug.Log("Hero art imported: 8 directions, 64 run frames, 8 idle frames; PPU 160, foot pivot, Point, FullRect.");
        }
    }
}
