...
{
    public sealed class MartialProcVfxImporter : AssetPostprocessor
    {
        public const string Folder = "Assets/Resources/Effects/MartialProcs";
        ...
        [MenuItem("37 MiniGame/Art/Reimport Martial Proc VFX")]
        public static void ImportAll()
        {
            ...
            Debug.Log("Martial proc VFX imported: " + paths.Length + " strips; six 256px frames, center pivot, Point.");
        }
    }
}
